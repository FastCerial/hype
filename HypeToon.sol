...
contract HypeToon is ERC20, Ownable
{
	...
	// External Method
	//---------------------------------------------------------------
	constructor(address address_genesis_vault, uint256 totalSupply) ERC20("HypeToon: Decentralized Webtoon Content Platform run by DAO", "HYPE") Ownable()
	{
		require(address_genesis_vault != address(0), "constructor: Wrong vault address");
		mint(address_genesis_vault, totalSupply);
	}
